...
class Wonton:
    ...
    def welcome(self):
        ...
        {Fore.GREEN + Style.BRIGHT}Auto Claim {Fore.BLUE + Style.BRIGHT}Wonton - BOT
            """
            f"""
        {Fore.GREEN + Style.BRIGHT}Edited by {Fore.YELLOW + Style.BRIGHT} The Shadowscripter (https://t.me/shadowscripters)
            """
        )
    ...
    def user_auth(self, query: str, retries=5):
        ...
        data = json.dumps({"initData":query, "inviteCode":"UKXFNK8G", "newUserPromoteCode":""})
        self.headers.update({
